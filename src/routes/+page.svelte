...
<section class="mb-10 max-w-3xl">
	...
	<p class="mt-3 text-slate-400">
		A little workshop of focused, well-implemented tools powered by the free
		<a
		...
		>. No accounts, no telemetry, no backend — your text goes straight from your browser to the
		model.
	</p>
